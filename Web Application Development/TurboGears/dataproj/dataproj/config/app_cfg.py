# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in dataproj.
...
import dataproj
from dataproj import model, lib
...
base_config.model = dataproj.model
base_config.DBSession = dataproj.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "d8cbcf86-1484-414e-89b9-f93a42652ffc"
