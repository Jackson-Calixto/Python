# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in demoproj.
...
import demoproj
from demoproj import model, lib
...
base_config.model = demoproj.model
base_config.DBSession = demoproj.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "ea96df85-856f-4ee7-accc-cfebc3cd89c8"
